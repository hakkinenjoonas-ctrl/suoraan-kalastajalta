...
function buildCatchPayload(entry: Record<string, unknown>, offers: Array<Record<string, unknown>>) {
  ...
  return {
    ...
    water_type: safeString(entry.water_type),
    ices_subdivision: safeString(entry.ices_subdivision),
    statistical_rectangle: safeString(entry.statistical_rectangle),
    marine_gear_code: safeString(entry.marine_gear_code),
    marine_gear_name: safeString(entry.marine_gear_name),
    fishing_day_id: safeString(entry.fishing_day_id),
...
function buildCatchPayloadFromRows(rows: Array<Record<string, unknown>>, offers: Array<Record<string, unknown>>) {
  ...
  return {
    ...
    water_type: safeString(first.water_type),
    ices_subdivision: safeString(first.ices_subdivision),
    statistical_rectangle: safeString(first.statistical_rectangle),
    marine_gear_code: safeString(first.marine_gear_code),
    marine_gear_name: safeString(first.marine_gear_name),
    fishing_day_id: safeString(first.fishing_day_id),
