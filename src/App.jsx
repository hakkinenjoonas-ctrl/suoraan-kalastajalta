  ...
  const gearProfiles = Object.fromEntries(
    Object.entries(parsedGearProfiles).map(([gearName, profile]) => [
      String(gearName || "").trim(),
      {
        ...
        fishingSecondaryValue: String(profile?.fishingSecondaryValue || ""),
        ...
        gearLength: String(profile?.gearLength || ""),
        gearWidth: String(profile?.gearWidth || ""),
        otherGearName: String(profile?.otherGearName || ""),
      },
    ]),
  );
  return {
    ...
    fishingSecondaryValue: String(parsed?.fishingSecondaryValue || ""),
    ...
    gearLength: String(parsed?.gearLength || ""),
    gearWidth: String(parsed?.gearWidth || ""),
    otherGearName: String(parsed?.otherGearName || ""),
    gearProfiles,
...
function getStoredGearProfile(defaults, gearName) {
  ...
  if (storedProfile) {
    return {
      ...
      fishingSecondaryValue: String(storedProfile.fishingSecondaryValue || ""),
      ...
      gearLength: String(storedProfile.gearLength || ""),
      gearWidth: String(storedProfile.gearWidth || ""),
      otherGearName: String(storedProfile.otherGearName || ""),
    };
  }
  ...
  return {
    ...
    fishingSecondaryValue: String(defaults?.fishingSecondaryValue || ""),
    ...
    gearLength: String(defaults?.gearLength || ""),
    gearWidth: String(defaults?.gearWidth || ""),
    otherGearName: String(defaults?.otherGearName || ""),
  };
}
...
export default function App() {
  ...
  const [form, setForm] = useState(() => {
    ...
    return {
      ...
      fishingSecondaryValue: initialGearDefaults.fishingSecondaryValue,
      inlandGearCode: getInlandGearCode(defaults.gear),
      inlandGearPresetId: "",
      managementFishing: false,
      effortOnly: false,
      gearLength: initialGearDefaults.gearLength,
      gearWidth: initialGearDefaults.gearWidth,
      otherGearName: initialGearDefaults.otherGearName,
      originCity: "",
      selectedVesselId: "",
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...
      fishingSecondaryValue: gearDefaults.fishingSecondaryValue,
      gear: defaults.gear,
      inlandGearCode: getInlandGearCode(defaults.gear),
      inlandGearPresetId: "",
      ...
      gearLength: gearDefaults.gearLength,
      gearWidth: gearDefaults.gearWidth,
      otherGearName: gearDefaults.otherGearName,
    ...
    try {
      ...
      const nextGearProfiles = {
        ...
        [form.gear || "Rysä"]: {
          ...
          fishingDurationOptions,
          fishingSecondaryValue: form.fishingSecondaryValue || "",
          ...
          fykeHeightOptions,
          gearLength: form.gearLength || "",
          gearWidth: form.gearWidth || "",
          otherGearName: form.otherGearName || "",
        },
      };
              ...
              <div style={formGrid}>
                ...
                <div style={styles.field}><label>{isMarineCatchForm(form, catchAreaSelector) ? "Merialueen pyydys" : "Pyydys"}</label><select style={styles.input} value={!isMarineCatchForm(form, catchAreaSelector) && form.inlandGearPresetId ? getInlandGearPresetOptionValue(form.inlandGearPresetId) : form.gear} onChange={(e) => {
                  ...
                  setForm((prev) => ({
                    ...
                    fishingSecondaryValue: nextGearDefaults.fishingSecondaryValue || "",
                    ...
                    gearLength: selectedPreset?.gearLength || (nextInlandGear?.technicalFields.includes("length") ? nextGearDefaults.gearLength || "" : ""),
                    gearWidth: selectedPreset?.gearWidth || (nextInlandGear?.technicalFields.includes("width") ? nextGearDefaults.gearWidth || "" : ""),
                    otherGearName: selectedPreset?.otherGearName || (nextInlandGear?.requiresOtherName ? nextGearDefaults.otherGearName || "" : ""),
