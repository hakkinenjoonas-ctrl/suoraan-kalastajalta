...
FMI-kysely=${waterTemperatureState.debug.fmiLastQueryLabel || "-"}
FMI-content-type=${waterTemperatureState.debug.fmiLastContentType || "-"}
FMI-root=${waterTemperatureState.debug.fmiLastRootElement || "-"}
FMI-BsWfsElement=${waterTemperatureState.debug.fmiLastBsElementCount ?? "-"}
FMI-poikkeus=${waterTemperatureState.debug.fmiLastException || "-"}
FMI-parametrit=${Array.isArray(waterTemperatureState.debug.fmiLastParameterNames) ? waterTemperatureState.debug.fmiLastParameterNames.join(", ") : "-"}
