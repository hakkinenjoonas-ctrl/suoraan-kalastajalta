...
const styles = {
  app: {
    minHeight: "100vh",
    background: "radial-gradient(circle at top left, #fff8ec 0%, #f5f9f6 38%, #edf4f2 70%, #e7eff2 100%)",
    color: "#12303a",
  ...
  card: {
    ...
    border: "1px solid rgba(186, 200, 193, 0.65)",
    borderRadius: 24,
    boxShadow: "0 24px 48px rgba(18, 48, 58, 0.08)",
    backdropFilter: "blur(10px)",
  },
  headerCard: {
    padding: 24,
    marginBottom: 22,
    background: "linear-gradient(135deg, rgba(255,250,240,0.96) 0%, rgba(238,246,242,0.96) 52%, rgba(228,240,244,0.96) 100%)",
    border: "1px solid rgba(169, 189, 181, 0.75)",
  },
  ...
  title: { margin: 0, fontSize: 38, lineHeight: 1.02, letterSpacing: "-0.04em", fontWeight: 800, color: "#153744" },
  subtitle: { margin: "8px 0 0", color: "#4b6872", fontSize: 14, lineHeight: 1.5 },
  badge: {
    display: "inline-flex",
    alignItems: "center",
    gap: 6,
    ...
    fontSize: 13,
    fontWeight: 600,
    border: "1px solid rgba(173, 194, 185, 0.9)",
  },
  ...
  tabs: {
    ...
    border: "1px solid rgba(186, 200, 193, 0.72)",
    padding: 8,
    borderRadius: 22,
    marginBottom: 18,
    boxShadow: "0 18px 36px rgba(18, 48, 58, 0.05)",
  },
  tabs6: {
    display: "grid",
  ...
  activeTab: { background: "linear-gradient(135deg, #1d4d59 0%, #254f3f 100%)", color: "#fff", boxShadow: "0 14px 28px rgba(29, 77, 89, 0.22)" },
  ...
  metric: { fontSize: 40, fontWeight: 800, margin: "10px 0 0", letterSpacing: "-0.04em", color: "#163844" },
  muted: { color: "#58717b", fontSize: 14, lineHeight: 1.55 },
  progress: { height: 12, background: "rgba(201, 215, 210, 0.66)", borderRadius: 999, overflow: "hidden" },
  progressFill: { display: "block", height: "100%", background: "linear-gradient(90deg, #1d4d59 0%, #2f6f5f 100%)", borderRadius: 999 },
  ...
  input: {
    width: "100%",
    padding: "13px 15px",
    border: "1px solid rgba(173, 194, 185, 0.95)",
    borderRadius: 16,
  ...
  button: {
    ...
    gap: 8,
    fontWeight: 700,
    boxShadow: "0 10px 22px rgba(18, 48, 58, 0.07)",
  },
  primaryButton: { background: "linear-gradient(135deg, #1d4d59 0%, #254f3f 100%)", color: "#fff", borderColor: "#1d4d59" },
  speciesBox: {
    border: "1px solid rgba(190, 206, 198, 0.78)",
    borderRadius: 20,
    background: "linear-gradient(135deg, rgba(250,252,250,0.96) 0%, rgba(239,246,243,0.96) 100%)",
    padding: 18,
  },
  speciesRow: {
    display: "grid",
    ...
    border: "1px solid rgba(196, 210, 203, 0.84)",
    borderRadius: 18,
    padding: 14,
    boxShadow: "0 10px 22px rgba(18, 48, 58, 0.04)",
  },
  entry: {
    border: "1px solid rgba(188, 203, 197, 0.74)",
    borderRadius: 20,
    padding: 16,
    background: "rgba(255,255,255,0.92)",
    boxShadow: "0 16px 34px rgba(18, 48, 58, 0.05)",
  },
  entryHeader: {
    display: "flex",
    justifyContent: "space-between",
  ...
  noticeError: {
    ...
    borderRadius: 16,
    fontSize: 14,
    background: "linear-gradient(135deg, #fff3f1 0%, #fff7f6 100%)",
    color: "#b23b34",
  ...
  noticeInfo: {
    ...
    borderRadius: 16,
    fontSize: 14,
    background: "linear-gradient(135deg, #eef8fb 0%, #f6fbff 100%)",
    color: "#235b77",
  ...
  noticeSuccess: {
    ...
    borderRadius: 16,
    fontSize: 14,
    background: "linear-gradient(135deg, #eefaf2 0%, #f7fcf8 100%)",
    color: "#24684e",
    border: "1px solid #bddfc9",
    whiteSpace: "pre-wrap",
  },
  small: { fontSize: 12, color: "#6b8088", lineHeight: 1.45 },
  offerBox: {
    border: "1px solid #c8ddd6",
    borderRadius: 20,
    background: "linear-gradient(135deg, #f7fbf8 0%, #edf6f3 55%, #edf5f7 100%)",
    padding: 18,
  },
  successHighlightBox: {
    border: "1px solid #b8ddc2",
    borderRadius: 20,
    background: "linear-gradient(135deg, #f1fbf4 0%, #f8fdf8 100%)",
    padding: 18,
  },
  ...
  checkboxCard: {
    ...
    padding: "11px 15px",
    borderRadius: 999,
    border: "1px solid rgba(173, 194, 185, 0.92)",
  ...
  qrBlock: {
    ...
    borderRadius: 18,
    border: "1px solid #c8ddd6",
    background: "linear-gradient(135deg, #fcfffd 0%, #f0f6f4 100%)",
    alignItems: "center",
    width: "fit-content",
  },
  qrImage: {
